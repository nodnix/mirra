...
Mirra 无需注册或登录。本文说明 Mirra 在提供镜像、控制、连接组件准备和问题反馈功能时如何处理数据。
...
首次连接可能从云端下载经过校验的连接组件，并可能访问 Apple 提供的验证服务。这些请求不会携带手机画面、声音或输入内容。Mirra 当前不在应用内自动检查或下载新版本；新版本通过 [GitHub Releases](https://github.com/nodnix/mirra/releases) 发布。
